...
function runCreator(event) {
    ...
    if (data.delay < 0 || data.step < 0 || data.amount < 0) {
        (0, _notiflixNotifyAio.Notify).failure("Please enter non-negative numbers");
        return;
    }
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"1IPtg":[function() {},{}]},["dDjGg","8tzFL"], "8tzFL", "parcelRequire7bc7")
